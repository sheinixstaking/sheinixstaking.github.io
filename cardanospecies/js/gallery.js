...
function updateTime(specie,countDownDate,functionName) {
  ...
  var countDownDateUTC = Date.UTC(countDownDate.getFullYear(),countDownDate.getMonth(),countDownDate.getDate(),countDownDate.getHours(),countDownDate.getMinutes(),countDownDate.getSeconds(),countDownDate.getMilliseconds());

  var timeleft = countDownDateUTC - nowUTC;
